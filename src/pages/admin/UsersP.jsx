  ...
  const columns = [
    ...
    },
    {
      ...
      render: ({ _id }) => (
        ...
        >
          <Button type="primary" onClick={() => editStudent(_id)}>
            Edit
          </Button>
          <Button type="primary" danger onClick={() => deleteStudent(_id)}>
            Delete
          </Button>
        </div>
      ),
      ...
      {loading ? (
        ...
        <div>
          ...
          <Pagination
            pageSize={PER_LIMIT}
            current={page}
            onChange={(page) => setPageUser(page)}
            total={totalUsers}
          />
          <Modal
            title="User"
